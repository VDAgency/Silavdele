  ...
  const plans = [
    {
      ...
      features: [
        ...
        "Telegram Premium на 3 месяца (1049₽)",
        "Setup-бот на 10$",
        "Внутренний курс — 916₽",
        "Доступ к инструментам v1.0",
    ...
    },
    {
      ...
      features: [
        ...
        "Telegram Premium на 6 месяцев (1399₽)",
        "Setup-бот на 50$",
        "Внутренний курс — 4581,5₽",
    ...
    },
    {
      ...
      features: [
        ...
        "Telegram Premium на 12 месяцев (2539₽)",
        "Setup-бот на 100$",
        "Внутренний курс — 9163₽",
